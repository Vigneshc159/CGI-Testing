...
public class InstallerRepo {
	...
	public @FindBy (id="ContentPlaceHolder1_gvCustomers_lnkEdit_6")WebElement installereditButton;
	...
	public @FindBy (id="ContentPlaceHolder1_gvNsfSetup_lnkEdit_8")WebElement nsfeditButton;
